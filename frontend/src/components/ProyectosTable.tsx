...
export default function ProyectosTable({ proyectos, total, onEdit, onDelete, loading }: ProyectosTableProps) {
                                ...
                                <tr key={p.id}>
                                    ...
                                    <td>
                                        <div className="row-actions">
                                            ...
                                            <button className="action-btn action-delete" onClick={() => onDelete(p.id)} title="Eliminar">
