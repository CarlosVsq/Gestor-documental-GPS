...
const menuItems: { id: ActivePage; label: string; icon: JSX.Element; section?: string }[] = [
  ...
  },
  {
    ...
    icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 17a4 4 0 0 0 8 0" /><path d="M5 17a4 4 0 0 1 8 0" /><path d="M7 7l3 3" /><path d="M14 7l-3 3" /><path d="M2 11l3-3 3 3" /><path d="M22 11l-3-3-3 3" /></svg>,
  },
  {
    id: 'areas',
    label: 'Áreas',
