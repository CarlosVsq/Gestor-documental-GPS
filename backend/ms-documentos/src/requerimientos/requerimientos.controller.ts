...
export class RequerimientosController {
  ...
  findAll(@Payload() payload: { page?: number; limit?: number; contratistaId?: number }) {
    return this.requerimientosService.findAll(payload?.page, payload?.limit, payload?.contratistaId);
  }
